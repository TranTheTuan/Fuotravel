...
export class RelationshipService {
  private APIS = {
    ...
    9: environment.apiURL + '/users/friendships/between/{target_id}'
  };
  ...
  getRelationshipBetween(targetId: any): Observable<ApiResponse> {
    const apiUrl = this.APIS[9].replace('{target_id}', targetId);
    return this.http.get<ApiResponse>(apiUrl);
  }
}
